...
public class C_ArcadeDrive extends Command {
    ...
    protected void initialize() {
    	...
    	SmartDashboard.putString("ssDriveTrain", "C_ArcadeDrive initialize");
    }
    ...
    protected void execute() {
		if(Robot.oi.driveControllerOn){
	    	...
	    	if(Robot.oi.driveController.getRawButton(4) == false){
	    		...
	    		Robot.ssDriveTrain.arcadeDrive(Speed*Speed*Speed, -Robot.oi.driveController.getRawAxis(0));
	    	}
	    	else{
    ...
    protected void end() {
    	SmartDashboard.putString("ssDriveTrain", "C_ArcadeDrive end");
    }

    // Called when another command which requires one or more of the same
    // subsystems is scheduled to run
    protected void interrupted() {
    	SmartDashboard.putString("ssDriveTrain", "C_ArcadeDrive interrupted");
    }
}
